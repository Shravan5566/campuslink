...
export const branches: Branch[] = [
  {
    ...
    subjects: [
      ...
      { id: "fe-2", name: "Engineering Physics", driveLink: "https://drive.google.com/placeholder" },
      { id: "fe-3", name: "Engineering Chemistry", driveLink: "https://drive.google.com/placeholder" },
      { id: "fe-4", name: "Basic Electrical Engineering", driveLink: "https://drive.google.com/placeholder" },
      { id: "fe-5", name: "Engineering Mechanics", driveLink: "https://drive.google.com/placeholder" },
